...
class CItemInfo
{
	...
	*/
	...
	{
		/*
		* Autogenerated by IdaParser on: 7/30/2021 5:29:14 PM
		*/
		struct RandomStat : ZRefCounted
		{
			int nMin;
			int nMax;
		};
		...
		/*
		* Autogenerated by IdaParser on: 7/30/2021 5:35:35 PM
		*/
		struct Recovery : ZRefCounted
		{
			int nHP;
			int nMP;
			int tInterval;
		...
		/*
		* Autogenerated by IdaParser on: 7/30/2021 5:32:35 PM
		*/
		struct Ability
		{
			ZXString<char> sDesc;
			ZRef<Recovery> pRecovery;
	...
	*/
	...
	/*
	* Autogenerated by IdaParser on: 7/31/2021 9:43:38 AM
	*/
	struct SETITEMINFO
	{
	   int nSetItemID;
	   ZArray<long> nItemID;
	   ZRef<SETEFFECT> pEffect[60];
	   ZXString<char> sSetItemName;
	   int nSetCompleteCount;
